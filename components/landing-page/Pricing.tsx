...
export function Pricing() {
    return (
        <section className="max-w-7xl mx-auto px-4 py-24 relative">
            ...
            >
                <div className="space-y-6 w-full md:w-[500px] relative p-8 transition-all duration-300 bg-background/30 hover:bg-white/5 backdrop-blur-sm shadow-lg hover:shadow-xl rounded-2xl border border-white/10">
                    ...
                    <div>
                        {[
                            ...
                            <div
                                key={index}
                                className="flex items-center gap-3 text-muted-foreground space-y-2"
                            >
