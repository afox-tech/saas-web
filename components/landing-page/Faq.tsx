...
const faqs = [
    ...
    {
        question: "How does ther preview system work?",
    ...
    return (
        <div className="w-full max-w-[1400px] mx-auto py-32 px-4">
            <AnimationContainer delay={0.1}>
                <h2 className="mb-12 text-3xl sm:text-4xl md:text-6xl font-bold text-center tracking-tight opacity-90">
                    FAQ
                </h2>
            </AnimationContainer>
                        ...
                        className={`px-6 py-5 text-lf rounded-xl transition-all duration-500 cursor-pointer backdrop-blur-md 
                                    ${
                                        selectedQuestion === index
                                            ...
                                            : "bg-background/20 hover:bg-white/5 border-white/5 hover:border-white/10"
                                    } border`}
                        transition={{
                            duration: 0.3,
                            type: "spring",
